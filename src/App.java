...
lastName.sendKeys("Bembey");

Thread.sleep(1000);

WebElement phone = driver.findElement(By.name("phone"));
phone.sendKeys("9068384931");

Thread.sleep(1000);

WebElement username = driver.findElement(By.name("userName"));
username.sendKeys("shivambembey98@gmail.com");

Thread.sleep(1000);

WebElement address = driver.findElement(By.name("address1"));
address.sendKeys("Sector-60");
...
loginUserName.sendKeys("shivambembey98@gmail.com");
...
confirmPassword.sendKeys("shivam@123");
